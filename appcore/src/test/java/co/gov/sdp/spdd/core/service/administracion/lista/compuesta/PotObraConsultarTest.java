...
@SpringBootTest(classes = { SessionFacadeAFS.class, PotObraConsultar.class, IPotObraConsultar.class})
class PotObraConsultarTest {
	
	@Autowired
	IPotObraConsultar consultar;
	...
	void testObtenerPotObra() throws SpddExceptions {
		GenericoDTO res;
		when(sessionFacadeAFS.consultarPotObra()).thenReturn(new GenericoDTO());
		res = consultar.obtenerPotObra();
		assertNotNull(res);
