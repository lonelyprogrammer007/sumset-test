...
@SpringBootTest(classes = { IAdministracionListaSimpleRegistrar.class, AdministracionListaSimpleRegistrar.class})
public class AdministracionListaSimpleRegistrarTest {
	...
	@Test
	public void testGuardarListaSimple() throws SpddExceptions {
		Long id=1L;	
		...
		res = registrar.guardarListaSimple(peticion);
		assertNotNull(res);
