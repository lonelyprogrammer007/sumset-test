...
@Entity
@Table(name = "SPDD_BP_PROY_INV_IDEN_LOCAL")
@Data
public class BpProyInvIdenLocal implements Serializable {

    private static final long serialVersionUID = 1L;
    @Id
    @GeneratedValue(strategy = GenerationType.IDENTITY)
    @Basic(optional = false)
    @Column(name = "ID_IDENTIFICA_LOCALIZA")
    private Long idIdentificaLocaliza;
