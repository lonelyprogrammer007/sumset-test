...
@Immutable
@Data
@Table(name = "V_BP_PROYECTO_INVERSION")
public class VistaBpProyectoInversion implements Serializable{
    ...
    @JoinColumn(name = "ID_LS_TIPO", referencedColumnName = "ID_ARGUMENTO")
    @ManyToOne(optional = false)
    private ArgumentoListaSimple idLsTipo;
